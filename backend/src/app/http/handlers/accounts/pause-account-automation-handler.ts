...
import type { PauseAccountAutomation } from "../../../../modules/orchestration/application/commands/pause-account-automation";

export async function pauseAccountAutomationHandler(
  command: PauseAccountAutomation,
  accountId: string,
